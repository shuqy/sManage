...
namespace DotNet.Utilities {
    public class FileOperate {
        ...
        protected void Write_Txt(string FileName, string Content) {
            ...
            string htmlfilename = HttpContext.Current.Server.MapPath(ConfigHelper.Get("TxtPath") + FileName + ".txt");　//保存文件的路径
            string str = Content;
        ...
        protected string Read_Txt(string filename) {
            ...
            Encoding code = Encoding.GetEncoding("gb2312");
            string temp = HttpContext.Current.Server.MapPath(ConfigHelper.Get("TxtPath") + filename + ".txt");
            string str = "";
            if (File.Exists(temp)) {
