                            ...
                            '<tr>' +
                                '<td colspan="2">' +
                                    '<div class="ui_title_bar">' +
                                        //'<div class="ui_title" unselectable="on"></div><div class="ui_titler" unselectable="on"></div>' +
    ...
    lhgdialog.fn = lhgdialog.prototype =
    {
        ...
        lock: function () {
            ...
            if (!mask) {
                ...
                mask.style.cssText = 'position:' + positionType + ';left:0;top:0;width:100%;height:100%;overflow:hidden;z-index:99999';
...
; (function ($, lhgdialog, undefined) {
    ...
    lhgdialog.confirm = function (content, yes, no, parent) {
        return lhgdialog({
            ...
            fixed: true,
            lock: true,
            content: "<span style='color:#f60;font-size:14px;font-family:Microsoft Yahei;line-height:30px;padding-left:8px;'>" + content + "</span>",
            resize: false,
            parent: parent || null,
            ok: function (here) {
    ...
    lhgdialog.tips = function (content, time, icon, callback) {
        ...
        .content("<span style='font-size:14px;font-family:Microsoft Yahei;line-height:30px;padding-left:8px;'>" + content + "</span>")
...
function showTip(v, t, callback) {
    ...
    var stmp = "<span style='color:#f60;font-size:14px;line-height:30px;font-family:Microsoft Yahei;padding:0 10px;'>" + v + "</span>";
    $.dialog({
        content: stmp, id: 'oneID', icon: icont, lock: true, time: 1.5, fixed: true, max: false, min: false, title: false, close: function () {
            var duration = 300,
                api = this,
                opt = api.config,
                wrap = api.DOM.wrap,
...
function showTip2(v, t, s) {
    ...
    var stmp = "<span style='color:#f60;font-size:14px;line-height:30px;font-family:Microsoft Yahei;padding:0 10px;'>" + v + "</span>";
    $.dialog({
        content: stmp, id: 'oneID', icon: icont, lock: true, time: s, fixed: true, max: false, min: false, title: false, close: function () {
            var duration = 300,
                api = this,
                opt = api.config,
                wrap = api.DOM.wrap,
...
//$.dialog({
//    content: '向上逐渐透明关闭窗口', time: 3, close: function () {
