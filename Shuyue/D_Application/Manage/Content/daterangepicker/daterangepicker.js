    ...
    DateRangePicker.prototype = {
        ...
        move: function () {
            ...
            if (this.opens == 'left') {
                ...
                this.container.css({
                    top: this.element.offset().top + this.element.outerHeight() - parentOffset.top+8,
                    left: this.element.offset().left - parentOffset.left-30,
                    right: 'auto'
                });
        ...
        renderCalendar: function (calendar, selected, minDate, maxDate) {
            ...
            if (!minDate || minDate.isBefore(calendar[1][1])) {
                html += '<th class="prev available"><i class="iconf icon-x-zuojt"></i></th>';
            } else {
                html += '<th></th>';
            }
            ...
            if (!maxDate || maxDate.isAfter(calendar[1][1])) {
                html += '<th class="next available"><i class="iconf icon-x-youjt"></i></th>';
            } else {
                html += '<th></th>';
            }
