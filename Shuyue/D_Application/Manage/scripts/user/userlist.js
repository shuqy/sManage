...
managebase.data.loadPage = function () {
    managebase.data.listTable = $("#dataTable").smDataTable({
        ...
        "fnServerParams": function (aoData) {
            aoData.push({ "name": "para_title", "value": "" });
        },
        "aaSorting": [],
        aoColumns: [
            {
            ...
            },
            {
                ...
                "fnCreatedCell": function (nTd, sData, oData, iRow, iCol) {
                    $(nTd).data("Id", sData);
                    $(nTd).html('<div class="tr-icon"><a class="smEdit" href="#"><i class="iconf icon-x-edit1"></i><div>修改</div></a><a class="smDel" href="#"><i class="iconf icon-x-del-01"></i><div>删除</div></a></div>');
                }
            }
        ]
    });
