...
namespace Core.Util
{
    public class NPOIHelper
    {
        ...
        static MemoryStream ExportDT(DataTable dtSource, string strHeaderText)
        {
            ...
            //    si.Author = "gege"; //填加xls文件作者信息  
            //    si.ApplicationName = "NPOI测试程序"; //填加xls文件创建程序信息  
            //    si.LastAuthor = "gege"; //填加xls文件最后保存者信息  
                ...
                for (int i = (HeaderRowIndex + 1); i <= sheet.LastRowNum; i++)
                {
                    try
                    {
                        ...
                        for (int j = row.FirstCellNum; j <= cellCount; j++)
                        {
                            ...
                            {
                                LogManager.WriteLog(LogFile.OtherError, exception.ToString());
                            }
                        }
        ...
        public static void InsertSheet(string outputFile, string sheetname, DataTable dt)
        {
            ...
            {
                LogManager.WriteLog(LogFile.OtherError, ex.ToString());
                throw;
            }
