...
namespace Core.Util
{
    public class MD5
    {
        ...
        /// 盟友加密密钥
        /// </summary>
        private static void MD5_InitERP()
        {
            //原始密钥
            //A = 0x67452301;  //in memory, this is 0x01234567
            //B = 0xefcdab89;  //in memory, this is 0x89abcdef
        ...
        public static byte[] MD5ArrayERP(byte[] input)
        {
            MD5_InitERP();
            UInt32[] block = MD5_Append(input);
            UInt32[] bits = MD5_Trasform(block);
        ...
        /// <returns></returns>
        public static string MD5StringERP(string message)
        {
        ...
        {
            return "rnMD5 (" + message + ") = " + MD5.MD5String(message);
        }
